...
class PDFReportGenerator:
    ...
    def add_title_page(self, title, subtitle, date_str):
        """Add professional title page with DataVista branding"""
        # Top branding
        self.story.append(Spacer(1, 0.5*inch))
        branding = Paragraph(
            "<font size=14><b>📊 DATAVISTA</b></font><br/><font size=9>Enterprise-Grade Data Analytics & Automated Reporting</font>",
            ParagraphStyle(
                'Branding',
                parent=self.styles['Normal'],
                fontSize=14,
        ...
        <b>Platform:</b> DataVista Professional Analytics<br/>
        <b>Version:</b> 2.0 (Enterprise Edition)<br/>
        ...
        footer_branding = Paragraph(
            "<i>Generated by DataVista - Enterprise-Grade Data Analytics Platform<br/>Transform Data into Insights</i>",
            ParagraphStyle(
                'FooterBranding',
                parent=self.styles['Normal'],
                fontSize=9,
    ...
    def add_executive_summary(self, analysis_results):
        ...
        • Numeric Columns: <b>{basic_stats.get('numeric_columns', 0)}</b><br/>
        • Categorical Columns: <b>{basic_stats.get('categorical_columns', 0)}</b><br/>
        • Date Columns: <b>{basic_stats.get('date_columns', 0)}</b><br/>
        • Missing Values: <b>{basic_stats.get('missing_values', 0)}</b><br/>
        • Duplicate Rows: <b>{basic_stats.get('duplicate_rows', 0)}</b>
        """
    ...
    def add_visualizations(self, chart_dir):
        ...
        for i, chart_file in enumerate(chart_files):
            ...
            if len(chart_title) > 2 and chart_title[0].isdigit() and chart_title[1].isdigit():
            ...
            try:
                ...
                # Add page break after every 2 charts to keep layout clean
                # But only if there are more charts to show
                if (i + 1) % 2 == 0 and (i + 1) < len(chart_files):
                    self.story.append(PageBreak())
    ...
    def add_conclusions(self):
        ...
        • Investigate any high correlation pairs to understand causal relationships.<br/>
        • Review categorical distributions to identify dominant groups or rare classes.<br/>
        • Use the generated visualizations to present findings to stakeholders.<br/>
        """
